...
export const COMMAND_META: { id: string; titleKey: string }[] = [
  ...
  { id: "accept-all-current", titleKey: "command.accept-all-current" },
  { id: "accept-all-incoming", titleKey: "command.accept-all-incoming" },
...
export function getCommandActions(): Record<string, () => void> {
  ...
  return {
    ...
    "accept-all-current": () => s.applyStrategyToAll("current"),
    "accept-all-incoming": () => s.applyStrategyToAll("incoming"),
